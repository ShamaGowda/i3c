`ifndef I3C_HDR_WRITE_READ_VIRTUAL_SEQ_LEN4_INCLUDED_
`define I3C_HDR_WRITE_READ_VIRTUAL_SEQ_LEN4_INCLUDED_
...
class i3c_hdr_write_read_virtual_seq_len4 extends top_virtual_base_seq;
  `uvm_object_utils(i3c_hdr_write_read_virtual_seq_len4)
  ...
  function new(string name = "i3c_hdr_write_read_virtual_seq_len4");
    super.new(name);
  endfunction
