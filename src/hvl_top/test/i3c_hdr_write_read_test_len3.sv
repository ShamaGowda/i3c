class i3c_hdr_write_read_test_len3 extends i3c_base_test;
  `uvm_component_utils(i3c_hdr_write_read_test_len3)

  i3c_daa_virtual_seq             daaSeq;
  i3c_hdr_write_read_virtual_seq_len3  hdrWriteReadSeq;

  function new(string name = "i3c_hdr_write_read_test_len3",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    hdrWriteReadSeq =
      i3c_hdr_write_read_virtual_seq_len3::type_id::create("hdrWriteReadSeq");
